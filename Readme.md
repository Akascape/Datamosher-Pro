...
<br>You can try around changing the values from 50-100 and see the results, you can visit to https://github.com/itsKaspar/tomato.git view more examples about the advanced tab.
<br>
