...
<br>Note: For python users who are not in windows, please download the correct version of ffglitch from ffglitch.org and extract it inside the ffglitch folder of Datamosher pro. (Only windows version is given in this repo)
# How to Use?
