...
- For Python users, just run the Datamosher-Pro.py file. If any module error pops up then just click on yes and the required module will get downloaded automatically. After installation of modules the program is ready to use. (Also make sure you have ffmpeg installed)
